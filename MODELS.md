...
Per-repo performance data for **cloudron-buzz-app-feature-cloudron-package**
from pattern-tracker and response-scoring databases.
Auto-generated by `generate-models-md.sh` — do not edit manually.

**Last updated**: 2026-07-22T03:10:56Z

- **Pattern data points**: 0
- **Scored responses**: 18
- **Scope**: cloudron-buzz-app-feature-cloudron-package (repo-specific)
...
Weighted average across all evaluated responses (correctness 30%, completeness
25%, code quality 25%, clarity 20%):

| Model | Responses | Avg Score | Avg Time (s) |
| ------- | ----------- | ----------- | -------------- |
| claude-opus-4 | 6 | 4.56/5.0 | N/A |
| claude-sonnet-4 | 6 | 4.28/5.0 | N/A |
| gemini-2.5-pro | 6 | 4.11/5.0 | N/A |
