...
main() {
	...
	assert_contains THIRD_PARTY_NOTICES.md "- Release commit: \`1fb49103002e898607a7f6fd554cb51e94d92e08\`" || return 1
	assert_contains THIRD_PARTY_NOTICES.md "- Image revision: \`f35930104bcbdb1332ff13735214ecb9fce1fc7b\`" || return 1
